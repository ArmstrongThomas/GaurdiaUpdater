...
namespace RTG_Updater
{
    public partial class Form : System.Windows.Forms.Form
    {
		...
		public Form()
		{
			...
			// Set common position for all controls
			Point commonPosition = new Point(updateButton.Left, updateButton.Top); // Use updateButton's position
			launchButton.Location = commonPosition;
			progressBar.Location = commonPosition;

			// Initially show the updateButton
